...
private getSavingsAccountUrl:string;
  ...
  public transfer(transfer:Transfer){
    ...
    return this.http.post<any>(this.transferUrl,opts,{responseType:"text" as "json"});
...
public depotransaction(transaction:Transaction){
    ...
    return this.http.post<any>(this.depositUrl,opts,{responseType:"text" as "json"});
...
public withdrawtransaction(transaction:Transaction){
    ...
    return this.http.post<any>(this.withdrawUrl,opts,{responseType:"text" as "json"});
...
public requestT(request:Request){
    ...
    return this.http.post<any>(this.requestUrl,opts,{responseType:"text" as "json"} );
