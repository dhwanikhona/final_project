...
private getSavingsAccountUrl:string;
  ...
  acceptUserRequest(requestId:number){
   ...
   //const requestId = reqId + "";
    ...
    return this.http.put<any>(this.acceptRequestUrl+'/'+requestId,new HttpHeaders({"Content-Type":"application/json","responseType":"text" as "json"}));
  }
  ...
  return this.http.put<any>(this.enableUsers+'/'+uId,new HttpHeaders({"Content-Type":"application/json","responseType":"text" as "json"}));
  }

  disableUserAccount(uId:string){

  return this.http.put<any>(this.disableUsers+'/'+uId,new HttpHeaders({"Content-Type":"application/json","responseType":"text" }));
  }
